                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          webImage(cubit.user!.data!.imageUrl, double.infinity,
                              full: true),
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                CircleAvatar(
                                    ...
                                    backgroundImage:
                                        (cubit.user!.data!.imageUrl == null ||
                                                cubit.user!.data!.imageUrl ==
                                                    "")
                                            ? const AssetImage(
                                ...
                                Text(
                                  cubit.user!.data!.firstName! +
                                      " " +
                                      cubit.user!.data!.lastName!,
                                  ...
                                  children: [
                                    const CircleAvatar(
                                      ...
                                      backgroundImage: AssetImage(
                                          "assets/images/mobile/Group1264.png"),
                                    ),
                                    const SizedBox(
                                      width: 20,
                                    ),
                              ...
                              InkWell(
                                onTap: () {
                                  showDialog(
                                      ...
                                      builder: (context) {
                                        return changeData(
                                            context, keyf, fname, lname, email);
                                      });
                                },
                                child: Container(
                                  decoration: BoxDecoration(
